...
import { Radio, Play, Pause, Loader2, Signal } from 'lucide-react';
...
export const StationButton = ({
  ...
  return (
    <button
      ...
      className={`group relative w-full text-left rounded-2xl p-5 transition-all duration-300 ease-out overflow-hidden select-none cursor-pointer ${
        isActive
        ...
        <div className="flex items-center gap-3.5 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              ...
              {station.badge && (
                <span className="hidden sm:inline-block px-2 py-0.5 text-[10px] uppercase font-mono tracking-widest bg-white/10 text-neutral-300 rounded-full border border-white/10">
                  {station.badge}
                </span>
              )}
            </div>
